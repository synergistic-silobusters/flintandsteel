...
module.exports = function(db) {
    ...
    module.create = function(title, description, authorId, eventId, tags, rolesreq, value, complexity) {
        var idea = IdeaModel.create(title, description, authorId, eventId, tags, rolesreq, value, complexity);
